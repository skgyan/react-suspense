...
Interseting terms
- Fetch on render - child component is responsible for fetching the info 
- Fetch then render - parent is responsible for fetching and then passing the data to child to render
- Render as you fetch - reqeust the code of the compoenent and the data at the same time and then bind them together
